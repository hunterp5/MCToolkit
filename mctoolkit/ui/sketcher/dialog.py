...
class SketcherDialog(QDialog):
    ...
    def load_structure_from_mol(self, mol: object | None, confirm_if_nonempty: bool = True) -> None:
    ...
    def _on_cleanup_layout(self) -> None:
        ...
        if issues:
            from mctoolkit.ui.sketcher.iupac_validate import format_iupac_issues
