...
_EXPORTS: dict[str, str] = {
    ...
    "ConforgeConformationsDialog": ".conforge_conformations",
    ...
    "ProteinPharmacophoreDialog": ".protein_pharmacophore",
    ...
    "TautomerGeneratorDialog": ".tautomer",
