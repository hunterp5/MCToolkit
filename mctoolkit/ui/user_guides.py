    ...
    GuideSection(
        ...
        (
            ...
            _e(
                ...
                "Generate Protomers",
                "Generate Protomers",
                "Enumerate ionization protomers (Tools → Prepare Structures → Protonate).",
            ),
            _e(
                "tools_tautomers",
                "Tautomers",
                "Tautomers",
                "Enumerate likely tautomers (Tools → Prepare Structures → Tautomers).",
            ),
            _e(
                "tools_neutralize",
                "Neutralize",
    ...
    GuideSection(
        ...
        (
            ...
            _e(
                ...
                "MM-GBSA",
                "MM-GBSA",
                "1-trajectory MM-GBSA scoring of a protein–ligand complex in Protein Viewer.",
            ),
            _e(
                "tools_md",
                "Molecular Dynamics",
