...
Canonical citations (plain text, copy-paste friendly) live in ``mctoolkit.reference.method_citations``.
...
When a Uni-pKa ionization ensemble is available (``mctoolkit.ionization``), LogD 7.4, LogS 7.4, and the
