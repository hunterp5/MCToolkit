...
from mctoolkit.ui.dialogs.mol_tools import GenerateConformationsDialog
from mctoolkit.workers.conformer_generation import (
...
def test_generate_conformations_dialog_fine_tune_params(qapp):  # noqa: ARG001
    ...
    dlg.ff_combo.setCurrentText("MMFF")
