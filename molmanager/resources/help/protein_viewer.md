...
6. Use **View → Render** to restyle or recolor protein and ligand separately (heteroatoms stay CPK), **View → Hydrogens** to show all or only polar explicit hydrogens, **View → Pocket** to inspect the binding site, or **View → All Atoms** to show protein side chains instead of ribbon.
