...
- **View → Pocket** — zoom to the ligand, draw nearby protein residues (within 4.5 Å) as ball-and-stick with residue labels, and show explicit polar hydrogens on the ligand and those residues. Select a ligand in the Manager first when more than one is loaded.
...
6. Use **View → Render** to restyle or recolor protein and ligand separately (heteroatoms stay CPK), **View → Pocket** to inspect the binding site, or **View → All Atoms** to show protein side chains instead of ribbon.
