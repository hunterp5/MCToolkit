...
The file format is JSON (`molmanager.pharmacophore` version 1), typically `.json` or `.mph4`. It is independent of the MCtoolkit session file; **Save…** writes it for other sessions.
