...
def load_crystal_mol(path: str | Path) -> Chem.Mol | None:
    ...
    try:
        ...
        if suf == ".pdbqt":
            from .dock_io import mol_from_pdbqt_block, split_ligand_pdbqt_records
...
def split_structure_holo(text: str, fmt: str) -> tuple[str, str] | None:
    ...
    from .structure_atoms import _pdb_from_atoms, parse_structure_atoms
    from .structure_component_types import AMINO_ACIDS, NUCLEIC_ACIDS
    from .structure_inventory import METAL_RESIDUES, WATER_RESIDUES
